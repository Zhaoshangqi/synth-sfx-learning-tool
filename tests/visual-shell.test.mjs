...
test('document shell includes premium audio-space background layers', () => {
  ...
  assert.match(html, /src="\.\/src\/visual-space\.js\?v=20260709-analog-gesture"/);
...
test('aether flow prompt adds magnetic particle flow lanes and transition-safe edge currents', () => {
  ...
  assert.match(html, /visual-space\.js\?v=20260709-analog-gesture/);
  assert.match(html, /styles-reference\.css\?v=20260709-analog-gesture/);
});
...
test('module entry points carry cache-busting versions for static Pages delivery', () => {
  ...
  assert.match(html, /src="\.\/src\/app\.js\?v=20260709-analog-gesture"/);
  assert.match(appJs, /from '\.\/sound-lab-model\.js\?v=20260709-analog-gesture'/);
  assert.match(appJs, /from '\.\/audio-player\.js\?v=20260709-analog-gesture'/);
  assert.match(appJs, /from '\.\/view-model\.js\?v=20260709-analog-gesture'/);
  assert.match(appJs, /from '\.\/render\.js\?v=20260709-analog-gesture'/);
});
...
test('v2 shell exposes the Sound Lab workbench and AudioWorklet path', () => {
  ...
  assert.match(audioPlayerJs, /sound-lab-model\.js\?v=20260709-analog-gesture/);
  assert.match(audioPlayerJs, /sound-lab-processor\.js/);
  assert.match(audioPlayerJs, /sound-lab-processor\.js\?v=20260709-analog-gesture/);
